...
import { IngredientsAccordionSection } from '@/components/sections/home/ingredients-accordion-section'; // Updated import
...
export default function HomePage() {
  return (
    <>
      ...
      <IngredientsAccordionSection /> {/* Updated component */}
    </>
  );
}
