  ...
  return (
    <div ref={fadeIn.ref} className={`container mx-auto px-4 py-12 md:py-16 ${fadeIn.className}`}>
      ...
      <div className="prose lg:prose-xl max-w-none mx-auto text-foreground/80">
        ...
        <p>
          You may use the Services only if you are 18 years or older and capable of forming a binding contract with wecare and are not barred from using the Services under applicable law.
        </p>
        ...
        <ul>
          ...
          <li>Use, display, mirror or frame the Services or any individual element within the Services, wecare's name, any wecare trademark, logo or other proprietary information, or the layout and design of any page or form contained on a page, without wecare's express written consent;</li>
          <li>Attempt to probe, scan or test the vulnerability of any wecare system or network or breach any security or authentication measures;</li>
        </ul>
        ...
        <p>
          NEITHER wecare NOR ANY OTHER PARTY INVOLVED IN CREATING, PRODUCING, OR DELIVERING THE SERVICES WILL BE LIABLE FOR ANY INCIDENTAL, SPECIAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES, OR DAMAGES FOR LOST PROFITS, LOST REVENUES, LOST SAVINGS, LOST BUSINESS OPPORTUNITY, LOSS OF DATA OR GOODWILL, SERVICE INTERRUPTION, COMPUTER DAMAGE OR SYSTEM FAILURE OR THE COST OF SUBSTITUTE SERVICES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR FROM THE USE OF OR INABILITY TO USE THE SERVICES.
        </p>
        ...
        <p>
          If you have any questions about these Terms, please contact us at legal@wecare.com.
        </p>
      </div>
    </div>
  );
