...
export function RollingBenefitsTiles() {
  ...
  return (
    <section ref={fadeIn.ref} className={`py-12 md:py-16 bg-primary overflow-hidden ${fadeIn.className}`}>
      <div className="container mx-auto px-4">
         <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 font-headline text-primary-foreground">Unlock Your Hair's Full Potential</h2>
      </div>
        ...
        <div className="flex animate-scroll-horizontal group-hover:pause-animation py-4">
          {duplicatedBenefits.map((benefit, index) => (
            <div key={`benefit-${index}`} className="mx-4 flex-shrink-0 w-auto">
              <div className="text-primary-foreground p-6 rounded-lg flex items-center space-x-3 min-w-[300px] h-20 justify-center">
